...
function Match(questions) {
  ...
  this.init = function () {
    ...
    for (var i = 0; i < this.questionSlice.length; ++i) {
      ...
      td.id='tdm'+i;
      td.className='m';
      td.innerHTML='<a href="javascript:M.move('+i+',-1);void(0)"><img src="http://dl.dropbox.com/u/44032519/up_8.png"/></a> <a href="javascript:M.move('+i+',1);void(0)"><img src="http://dl.dropbox.com/u/44032519/down_8.png"/></a>';
...
// GENERIC
function FCGid(i){return document.getElementById(i);}
function FCOpac(id,n){FCGid(id).style.filter='alpha(opacity='+n+')';FCGid(id).style.opacity=n/100;}
